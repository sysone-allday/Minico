...
public class MiniroomController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        // 캐릭터/이름표 매니저 생성
        characterManager = new allday.minico.ui.miniroom.CharacterManager(roomPane, visitorCharacters, characterNameLabels);
        ...
        // 플레이어 이름 입력받기
        javafx.application.Platform.runLater(this::setupPlayerName);
    }
